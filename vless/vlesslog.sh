...
cat /etc/wildydev21/xray-mini-nontls/access.log | grep -w $hariini | grep -w $waktu | tail -n500 | grep -w 'accepted' | grep -w $client;
cat /etc/wildydev21/xray-mini-tls/access.log | grep -w $hariini | grep -w $waktu | tail -n500 | grep -w 'accepted' | grep -w $client;
