...
# // Successfull
echo "Your Premium ShadowsocksR" | tee -a /etc/wildydev21/ssr/${Username}/config.log;
...
echo " BW Limit   = $bandwidth_alloweds" | tee -a /etc/wildydev21/ssr/${Username}/config.log;
echo "==============================" | tee -a /etc/wildydev21/ssr/${Username}/config.log;
